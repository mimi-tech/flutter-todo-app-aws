...
class _ConfirmUserState extends State<ConfirmUser> {
  final _confirmUserForm = GlobalKey<FormState>();
  final FocusNode myFocusNodeConfirmUser = FocusNode();
  final FocusNode myFocusNodeCode = FocusNode();
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: const InputDecoration(
                                      ...
                                      prefixIcon: Icon(Icons.add_circle_outline,size: 30,color: Colors.white,),
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: (state is AuthLoading)? () => {null} :  () => {
                                        if(validateForm()){
                                          BlocProvider.of<AuthBloc>(context).confirmUser(Constants.userEmail.toString(), codeController.text)
                                        }
                                      },
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                          content:  Text("Code sent successfully",style: TextStyle(color: Colors.green),),
  ...
  bool validateForm() {
    if (_confirmUserForm.currentState!.validate()) {
      _confirmUserForm.currentState?.save();
      return true;
    } else {
      return false;
    }
